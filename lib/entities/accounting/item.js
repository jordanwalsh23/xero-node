...
var Item = Entity.extend(ItemSchema, {
    ...
    save: function(options) {
        ...
        return this.application.putOrPostEntity(method, path, xml, { entityPath: 'Items', entityConstructor: function(data) { return self.application.core.items.newItem(data) } });
    }
});
