...
var TrackingCategory = Entity.extend(TrackingCategorySchema, {
    ...
    fromXmlObj: function(obj) {
        ...
        if (obj.Options) {
            this.extractArray(obj.Options, this.Options);
        }
    ...
    save: function(options) {
        ...
        return this.application.putOrPostEntity(method, path, xml, { entityPath: 'TrackingCategories', entityConstructor: function(data) { return self.application.core.trackingCategories.newTrackingCategory(data) } });
    },
    saveTrackingOptions: function(trackingOptions, trackingOptionID) {
        ...
        return this.application.putOrPostEntity(method, path, xml, { entityPath: 'Options', entityConstructor: function(data) { return self.application.core.trackingCategories.newTrackingOption(data) } });
    },
