...
var Contact = Entity.extend(ContactSchema, {
    ...
    save: function() {
        ...
        return this.application.putOrPostEntity(method, path, xml, { entityPath: 'Contacts', entityConstructor: function(data) { return self.application.core.contacts.newContact(data) } })
    }
});
