...
var Invoice = Entity.extend(InvoiceSchema, {
    ...
    fromXmlObj: function(obj) {
        ...
        if (obj.Contact) {
            _.merge(obj.Contact, this.Contact);
        }

        return this;
    },
    toXml: function() {
        var invoice = _.omit(this.toObject(), 'Contact', 'LineItems', 'Payments', 'CreditNotes', 'InvoiceID', 'HasAttachments', 'AmountDue', 'AmountPaid', 'FullyPaidOnDate', 'AmountCredited', 'UpdatedDateUTC');
        ...
        if (this.Contact) {
            invoice.Contact = this.Contact.toObject()
        }
