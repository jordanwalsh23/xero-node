...
var BankTransfer = Entity.extend(BankTransferSchema, {
    ...
    save: function() {
        ...
        return this.application.putOrPostEntity('put', 'BankTransfers', xml, { entityPath: 'BankTransfers', entityConstructor: function(data) { return self.application.core.bankTransfers.newBankTransfer(data) } });
    }
});
