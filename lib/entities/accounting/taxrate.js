...
var TaxRate = Entity.extend(TaxRateSchema, {
    ...
    save: function(options) {
        ...
        return this.application.putOrPostEntity(method, path, xml, { entityPath: 'TaxRates', entityConstructor: function(data) { return self.application.core.taxRates.newTaxRate(data) } });
    },
