...
var Account = Entity.extend(AccountSchema, {
    ...
    save: function(options) {
        ...
        return this.application.putOrPostEntity(method, path, xml, { entityPath: 'Accounts', entityConstructor: function(data) { return self.application.core.accounts.newAccount(data) } })
    }
});
