...
var AccountSchema = Entity.SchemaObject({
...
var Account = Entity.extend(AccountSchema, {
    ...
    save: function(options) {
        ...
        return this.application.putOrPostEntity(method, path, JSON.stringify(self), { entityPath: 'Accounts', entityConstructor: function(data) { return self.application.core.accounts.newAccount(data) } })
    }
});
