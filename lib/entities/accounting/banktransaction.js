...
var BankTransaction = Entity.extend(BankTransactionSchema, {
    ...
    save: function() {
        ...
        return this.application.putOrPostEntity(method, path, xml, { entityPath: 'BankTransactions', entityConstructor: function(data) { return self.application.core.bankTransactions.newBankTransaction(data) } })
    }
});
