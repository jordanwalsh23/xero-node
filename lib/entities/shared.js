...
const AddressDetailsSchema = Entity.SchemaObject({
...
module.exports.LineItemSchema = Entity.SchemaObject({
  ...
  Tracking: {
    type: Array,
    arrayType: TrackingCategorySchema,
    toObject: 'hasValue',
  },
